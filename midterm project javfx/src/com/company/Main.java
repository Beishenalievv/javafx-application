...
public class Main extends Application {
   ...
   public void start(Stage stage) {
        ...
        stage.setTitle("BAKBERGEN BEISHENALIEV");
        stage.getIcons().add(new Image("https://icons.iconarchive.com/icons/icons8/windows-8/512/Astrology-Year-Of-Snake-icon.png"));
        stage.show();
